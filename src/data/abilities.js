export const abilities = {
  "stench": {
    ...
    "detailedEffect": "This Pokémon's damaging moves have a 10% chance to make the target flinch with each hit if they do not already cause flinching as a secondary effect.\n\nThis ability does not stack with a held item.\n\nOverworld: The wild encounter rate is halved while this Pokémon is first in the party."
  },
  "drizzle": {
    "id": 2,
    "name": "drizzle",
  ...
  "speed-boost": {
    ...
    "detailedEffect": "This Pokémon's Speed rises one stage after each turn."
  },
  "battle-armor": {
    "id": 4,
    "name": "battle-armor",
    ...
    "detailedEffect": "Moves cannot score critical hits against this Pokémon.\n\nThis ability functions identically to shell armor."
  },
  "sturdy": {
    "id": 5,
    "name": "sturdy",
    ...
    "detailedEffect": "When this Pokémon is at full HP, any hit that would knock it out will instead leave it with 1 HP.  Regardless of its current HP, it is also immune to the one-hit KO moves: fissure, guillotine, horn drill, and sheer cold.\n\nIf this Pokémon is holding a focus sash, this ability takes precedence and the item will not be consumed."
  },
  "damp": {
    "id": 6,
    "name": "damp",
    ...
    "detailedEffect": "While this Pokémon is in battle, self destruct and explosion will fail and aftermath will not take effect."
  },
  "limber": {
    "id": 7,
    "name": "limber",
  ...
  "water-absorb": {
    ...
    "detailedEffect": "Whenever a water-type move hits this Pokémon, it heals for 1/4 of its maximum HP, negating any other effect on it.\n\nWater moves will ignore this Pokémon's substitute."
  },
  "oblivious": {
    "id": 12,
    "name": "oblivious",
  ...
  "cloud-nine": {
    ...
    "detailedEffect": "While this Pokémon is in battle, weather can still be in play, but will not have any of its effects.\n\nThis ability functions identically to air lock."
  },
  "compound-eyes": {
    "id": 14,
    "name": "compound-eyes",
  ...
  "effect-spore": {
    ...
    "detailedEffect": "Whenever a move makes contact with this Pokémon, the move's user has a 30% chance of being paralyzed, poisoned, or put to sleep, chosen at random.\n\nNothing is done to compensate if the move's user is immune to one of these ailments; there is simply a lower chance that the move's user will be affected."
  },
  "synchronize": {
    "id": 28,
    "name": "synchronize",
  ...
  "swift-swim": {
    ...
    "detailedEffect": "This Pokémon's Speed is doubled during rain.\n\nThis bonus does not count as a stat modifier."
  },
  "chlorophyll": {
    "id": 34,
    "name": "chlorophyll",
    ...
    "detailedEffect": "This Pokémon's Speed is doubled during strong sunlight.\n\nThis bonus does not count as a stat modifier."
  },
  "illuminate": {
    "id": 35,
    "name": "illuminate",
    ...
    "detailedEffect": "Overworld: If the lead Pokémon has this ability, the wild encounter rate is doubled.\n\nThis ability has no effect in battle."
  },
  "trace": {
    "id": 36,
    "name": "trace",
  ...
  "huge-power": {
    ...
    "detailedEffect": "This Pokémon's Attack is doubled while in battle.\n\nThis bonus does not count as a stat modifier.\n\nThis ability functions identically to pure power."
  },
  "poison-point": {
    "id": 38,
    "name": "poison-point",
    ...
    "detailedEffect": "Whenever a move makes contact with this Pokémon, the move's user has a 30% chance of being poisoned."
  },
  "inner-focus": {
    "id": 39,
    "name": "inner-focus",
    ...
    "detailedEffect": "This Pokémon cannot flinch."
  },
  "magma-armor": {
    "id": 40,
    "name": "magma-armor",
  ...
  "rain-dish": {
    ...
    "detailedEffect": "This Pokémon heals for 1/16 of its maximum HP after each turn during rain."
  },
  "sand-stream": {
    "id": 45,
    "name": "sand-stream",
    "generation": "generation-iii",
    "effect": "Summons a sandstorm that lasts indefinitely upon entering battle.",
    "detailedEffect": "The weather changes to a sandstorm when this Pokémon enters battle and does not end unless cancelled by another weather condition.\n\nIf multiple Pokémon with this ability, drizzle, drought, or snow warning are sent out at the same time, the abilities will activate in order of Speed, respecting trick room.  Each ability's weather will cancel the previous weather, and only the weather summoned by the slowest of the Pokémon will stay.\n\nOverworld: If the lead Pokémon has this ability, the wild encounter rate is halved in a sandstorm."
  },
  "pressure": {
    "id": 46,
    "name": "pressure",
  ...
  "thick-fat": {
    ...
    "detailedEffect": "This Pokémon takes half as much damage from fire- and ice-type moves."
  },
  "early-bird": {
    "id": 48,
    "name": "early-bird",
  ...
  "run-away": {
    ...
    "detailedEffect": "This Pokémon is always successful fleeing from wild battles, even if trapped by a move or ability."
  },
  "keen-eye": {
    "id": 51,
    "name": "keen-eye",
  ...
  "pickup": {
    ...
    "detailedEffect": "At the end of each turn, if another Pokémon consumed or Flung a held item that turn, this Pokémon picks up the item if it is not already holding one.  After each battle, this Pokémon has a 10% chance of picking up an item if it is not already holding one.\n\nThe air balloon and eject button cannot be picked up.\n\nThe items that may be found vary by game, and, since Pokémon Emerald, by the Pokémon's level.  This ability is checked after the battle ends, at which point any temporary ability changes have worn off."
  },
  "truant": {
    "id": 54,
    "name": "truant",
  ...
  "shed-skin": {
    ...
    "detailedEffect": "After each turn, this Pokémon has a 33% of being cured of any major status ailment."
  },
  "guts": {
    "id": 62,
    "name": "guts",
    ...
    "detailedEffect": "Whenever this Pokémon is asleep, burned, paralyzed, or poisoned, it has 1.5× its Attack.  This Pokémon is not affected by the usual Attack cut from a burn.\n\nThis bonus does not count as a stat modifier."
  },
  "marvel-scale": {
    "id": 63,
    "name": "marvel-scale",
    ...
    "detailedEffect": "Whenever this Pokémon has a major status ailment, it has 1.5× its Defense.\n\nThis bonus does not count as a stat modifier."
  },
  "liquid-ooze": {
    "id": 64,
    "name": "liquid-ooze",
    ...
    "detailedEffect": "Whenever a Pokémon would heal after hitting this Pokémon with a leeching move like absorb, it instead loses as many HP as it would usually gain.\n\ndream eater is unaffected."
  },
  "overgrow": {
    "id": 65,
    "name": "overgrow",
    ...
    "detailedEffect": "When this Pokémon has 1/3 or less of its HP remaining, its grass-type moves inflict 1.5× as much regular damage."
  },
  "blaze": {
    "id": 66,
    "name": "blaze",
    ...
    "detailedEffect": "When this Pokémon has 1/3 or less of its HP remaining, its fire-type moves inflict 1.5× as much regular damage."
  },
  "torrent": {
    "id": 67,
    "name": "torrent",
    ...
    "detailedEffect": "When this Pokémon has 1/3 or less of its HP remaining, its water-type moves inflict 1.5× as much regular damage."
  },
  "swarm": {
    "id": 68,
    "name": "swarm",
    ...
    "detailedEffect": "When this Pokémon has 1/3 or less of its HP remaining, its bug-type moves inflict 1.5× as much regular damage.\n\nOverworld: If the lead Pokémon has this ability, the wild encounter rate is increased."
  },
  "rock-head": {
    "id": 69,
    "name": "rock-head",
  ...
  "arena-trap": {
    ...
    "detailedEffect": "While this Pokémon is in battle, opposing Pokémon cannot flee or switch out.  flying-type Pokémon and Pokémon in the air, e.g. due to levitate or magnet rise, are unaffected.\n\nPokémon with run away can still flee.  Pokémon can still switch out with the use of a move or item.\n\nOverworld: If the lead Pokémon has this ability, the wild encounter rate is doubled."
  },
  "vital-spirit": {
    "id": 72,
    "name": "vital-spirit",
  ...
  "pure-power": {
    ...
    "generation": "generation-iii",
    "effect": "Doubles Attack in battle.",
    "detailedEffect": "This Pokémon's Attack is doubled in battle.\n\nThis bonus does not count as a stat modifier.\n\nThis ability functions identically to huge power."
  },
  "shell-armor": {
    "id": 75,
    "name": "shell-armor",
